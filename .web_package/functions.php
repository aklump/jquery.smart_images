 ...
 *
 * @code
 *   exit(cp_with_token_replacement(
 *     ($source_file = $argv[7] . '/src/smart-images.js'),
 *     $argv[7] . '/dist/smart-images.js'
 *   ));
 * @endcode
 */
function cp_with_token_replacement($source_path, $output_parent_dir = 'dist', array $additional_token_map = []) {
